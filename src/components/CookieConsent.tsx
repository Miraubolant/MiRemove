...
export function CookieConsent() {
  ...
  const [showDetails, setShowDetails] = useState(true); // Afficher les détails par défaut
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-6">
      {/* Overlay amélioré avec animation de flou */}
      <div 
      ...
      >
        <div className="relative bg-slate-900/95 backdrop-blur-sm rounded-2xl shadow-2xl border border-gray-800/50 overflow-hidden">
          ...
          {/* Section des détails avec nouvelle animation */}
