    ...
    >
      ...
      <div className="flex flex-col items-center relative z-10">
        ...
        >
          ...
          <div className="relative bg-emerald-600 p-4 sm:p-6 rounded-full shadow-xl shadow-emerald-500/20 mb-4 sm:mb-6 group-hover:shadow-emerald-500/30 transition-all duration-500">
        ...
        <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 sm:mb-3 text-center px-4">
          {isDragging ? "Déposez pour importer" : "Glissez vos images ici"}
        </h3>
        
        <p className="text-emerald-400/90 font-medium text-base mb-3 sm:mb-4 text-center max-w-md">
          Ou utilisez le sélecteur de fichiers pour parcourir vos images
        </p>
        
        <div className="flex items-center gap-3 text-gray-300 mb-4 sm:mb-6 bg-slate-800 px-4 py-2 rounded-full">
