/*
  # Add default legal content

  1. Changes
    - Add comprehensive default content for privacy policy
    - Add comprehensive default content for terms of service
    - Add comprehensive default content for GDPR compliance
