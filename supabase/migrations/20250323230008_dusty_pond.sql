/*
  # Add function to update default image limit
  
  1. New Function
    - update_default_image_limit - Updates the default image limit in the system
...
-- Create function to update default image limit
